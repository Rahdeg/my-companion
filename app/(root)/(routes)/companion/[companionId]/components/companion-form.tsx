            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8 pb-10'>
                ...
                render={({field})=>(
                    <FormItem className='flex flex-col items-center justify-center space-y-4'>
                        <FormControl>
                           <ImageUpload disable={isLoading} onChange={field.onChange} value={field.value}/>
                        </FormControl>
                        <FormMessage/>
                    </FormItem>
                )}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    render={({field})=>(
                        ...
                        <FormControl>
                        <Input disabled={isLoading} placeholder='Rahdeg' {...field}/>
                        </FormControl>
                    ...
                    render={({field})=>(
                        ...
                        <FormControl>
                        <Input disabled={isLoading} placeholder='Manager of Telsa..' {...field}/>
                        </FormControl>
                ...
                <FormField
                    ...
                    render={({field})=>(
                        ...
                        <FormDescription>Describe in details your companion&apos;s backstory and relevant details.</FormDescription>
                        <FormMessage/>
                        </FormItem>
                    )}
                    />
